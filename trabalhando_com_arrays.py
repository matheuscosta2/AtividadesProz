...
lista_de_produtos_amazon = ["Echo Dot 3", "Kindle", "Amazfit", "Echo pop", "Eco Show" ]
lista_de_anos_nascimento = [1994, 1995, 1973, 1910, 1989 ]
print(lista_de_produtos_amazon, lista_de_anos_nascimento)
